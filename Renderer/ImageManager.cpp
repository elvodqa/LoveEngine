...
void renderer::image_manager::init() {
        ...
        vkc(vkCreateDescriptorSetLayout(renderer::device, &imageLayoutCI,renderer::g_vk_Allocator, &imageSetLayout));
...
int renderer::image_manager::register_image(const EngineImage *image, VkImageLayout read_time_image_layout) {
    ...
    VkDescriptorImageInfo descriptorImageInfo ={
        ...
        .imageLayout = (read_time_image_layout!=VkImageLayout{})?read_time_image_layout:image->imageLayout[0],
    };
